 ...
 */
public class MonthlyClosingAdapter extends RecyclerView.Adapter<MonthlyClosingAdapter.SalesHolder> {
    ...
    public MonthlyClosingAdapter(Context context, List<Product> fpsSalesDayProductList) {
    ...
    public void onBindViewHolder(SalesHolder holder, int position) {
        ...
        holder.qty.setText(""+fpsSalesDayProductList.get(position).getClosingBalance());
    }
