...
public class UndoBar {
    ...
    protected final com.omneagate.UndoBar.ViewCompat mViewCompat;
    ...
    protected void animateOut() {
        mViewCompat.animateOut(mAnimationDuration, new com.omneagate.UndoBar.ViewCompat.AnimatorListener() {
            @Override
    ...
    public static class Builder {
         ...
         * configuration.
         */
        public com.omneagate.UndoBar.UndoBar create() {
            com.omneagate.UndoBar.UndoBar undoBarController = new com.omneagate.UndoBar.UndoBar(mWindow, mStyle);
