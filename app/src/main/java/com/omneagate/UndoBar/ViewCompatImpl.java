...
@SuppressLint("NewApi")
class ViewCompatImpl extends com.omneagate.UndoBar.ViewCompat {
    ...
    @Override
    void animateOut(long duration, final com.omneagate.UndoBar.ViewCompat.AnimatorListener animatorListener) {
        mViewPropertyAnimator.cancel();
