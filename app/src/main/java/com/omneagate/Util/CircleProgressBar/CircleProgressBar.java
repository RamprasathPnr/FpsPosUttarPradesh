...
//        </attr>
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = com.omneagate.Util.CircleProgressBar.CircleProgressBar.this.getWidth();
            final int viewHeight = com.omneagate.Util.CircleProgressBar.CircleProgressBar.this.getHeight();
