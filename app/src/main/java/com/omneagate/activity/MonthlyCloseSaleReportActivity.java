...
import com.omneagate.activity.dialog.FromDialogCloseSaleReport;
import com.omneagate.activity.dialog.FromDialogMonthlySalesReport;
import com.omneagate.activity.dialog.ToDialogCloseSaleReport;
 ...
 */
public class MonthlyCloseSaleReportActivity extends BaseActivity implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    FromDialogCloseSaleReport fromDialog;
    ToDialogCloseSaleReport toDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpInitialPage();
        fromDialog = new FromDialogCloseSaleReport(MonthlyCloseSaleReportActivity.this);
        toDialog = new ToDialogCloseSaleReport(MonthlyCloseSaleReportActivity.this);
    }
    ...
    private void setUpInitialPage() {
        try {
            ...
            Util.LoggingQueue(this, "MonthlyCloseSaleReportActivity", "Starting up page Called");
    ...
    public void setFromTextDate(String textDate) {
        Util.LoggingQueue(com.omneagate.activity.MonthlyCloseSaleReportActivity.this, "MonthlySalesReportActivity", "Searching by from date");
    ...
    public void setToTextDate(String textDate) {
        Util.LoggingQueue(com.omneagate.activity.MonthlyCloseSaleReportActivity.this, "MonthlySalesReportActivity", "Searching by to date");
    ...
    private void dateBySearch() {
        try {
            ...
            if(d1.compareTo(d2) > 0) {
                ...
                Util.LoggingQueue(this, "MonthlyCloseSalesReportActivity", "date search:" + from + " , " + to + " , "+ d1.compareTo(d2));
                Intent intent = new Intent(this, CloseSaleSummaryActivity.class);
