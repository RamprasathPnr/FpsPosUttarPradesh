...
import com.omneagate.activity.dialog.FromDialogMonthlyInventoryReport;
import com.omneagate.activity.dialog.FromDialogMonthlySalesReport;
import com.omneagate.activity.dialog.ToDialogMonthlyInventoryReport;
 ...
 */
public class MonthlyInventoryReportActivity extends BaseActivity implements View.OnFocusChangeListener, View.OnClickListener {
...
//    long dateSelection = 0l;
    ...
    FromDialogMonthlyInventoryReport fromDialog;
    ToDialogMonthlyInventoryReport toDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Util.LoggingQueue(MonthlyInventoryReportActivity.this, "MonthlyInventoryReportActivity", "onCreate() called");
        setUpInitialPage();

        fromDialog = new FromDialogMonthlyInventoryReport(com.omneagate.activity.MonthlyInventoryReportActivity.this);
        toDialog = new ToDialogMonthlyInventoryReport(com.omneagate.activity.MonthlyInventoryReportActivity.this);
    ...
    public void setFromTextDate(String textDate) {
        Util.LoggingQueue(com.omneagate.activity.MonthlyInventoryReportActivity.this, "MonthlyInventoryReportActivity", "Searching by from date");
    ...
    public void setToTextDate(String textDate) {
        Util.LoggingQueue(com.omneagate.activity.MonthlyInventoryReportActivity.this, "MonthlyInventoryReportActivity", "Searching by to date");
        ...
        try {
            ...
            if(!fromDate.getText().toString().isEmpty()) {
                ...
                if (d1.compareTo(d2) > 0) {
                    ...
                    Util.LoggingQueue(this, "MonthlyInventoryReportActivity", "date search:" + from + " , " + to);
                    Intent intent = new Intent(this, StockCheckSummaryActivity.class);
            ...
            Util.LoggingQueue(this, "MonthlyInventoryReportActivity", "error:" + e.toString());
        }
    }
    ...
    public void onBackPressed() {
        ...
        Util.LoggingQueue(this, "MonthlyInventoryReportActivity", "On back pressed calling");
        finish();
    }
