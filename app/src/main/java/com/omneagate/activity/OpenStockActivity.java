...
public class OpenStockActivity extends BaseActivity implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Util.LoggingQueue(this, "OpenStockActivity", "onCreate() called");
    ...
    private void getResult() {
        Util.LoggingQueue(this, "OpenStockActivity", "getResult() called");
        ...
        for (Integer data : productReceived.keySet()) {
            ...
            if (StringUtils.isNotEmpty(value) && Double.parseDouble(value) >= 0.0) {
                ...
                Util.LoggingQueue(this, "OpenStockActivity", "getResult() value "+ value  );
...
//            if (StringUtils.isNotEmpty(value)) {
                ...
                Util.messageBar(OpenStockActivity.this, getString(R.string.opening_stock_mandatory_alert));
                return;
            }
        }
        if (fpsStockDto.size() > 0) {
            ...
            Util.LoggingQueue(com.omneagate.activity.OpenStockActivity.this, "openstockEntry activity", "Back button pressed");
            finish();

        } else {
//            Util.messageBar(com.omneagate.activity.OpenStockActivity.this, getString(R.string.no_records));
            Util.messageBar(OpenStockActivity.this, getString(R.string.opening_stock_mandatory_alert));
            return;
        }
    }
    ...
    private void processData(List<ProductDto> productDtos) {
        if (productDtos.size() != 0) {
            ...
            for (ProductDto products : productDtos) {
                LayoutInflater lin = LayoutInflater.from(com.omneagate.activity.OpenStockActivity.this);
                FPSStockHistoryDto stockHistory = FPSDBHelper.getInstance(this).getAllProductOpeningStockDetails(products.getId());
                FPSStockDto fpsStock = FPSDBHelper.getInstance(com.omneagate.activity.OpenStockActivity.this).getAllProductStockDetails(products.getId());
...
//        sale = Util.quantityRoundOffFormat(sale);
        addOpenStockEt.setText(Util.quantityRoundOffFormat(sale));
...
//        openStock = Util.quantityRoundOffFormat(openStock);
        openingStockTv.setText(Util.quantityRoundOffFormat(openStock));
