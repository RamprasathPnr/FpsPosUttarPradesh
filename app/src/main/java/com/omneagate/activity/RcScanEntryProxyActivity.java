...
public class RcScanEntryProxyActivity extends BaseActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rc_scan_entry_proxy);
    ...
    private void setUpInitialScreen() {
        ...
        rcNumber.setOnFocusChangeListener(RcScanEntryProxyActivity.this);
        findViewById(R.id.submitButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((rcNo != null) && (!rcNo.equalsIgnoreCase("null")) && StringUtils.isNotEmpty(rcNo.trim())) {
                    Intent intent = new Intent(RcScanEntryProxyActivity.this, AddProxyActivity.class);
...
//                        getCardHolderDetailsFromUfcNo(contents.trim());
                        BeneficiaryDto benef = FPSDBHelper.getInstance(RcScanEntryProxyActivity.this).beneficiaryDto(contents.trim());
