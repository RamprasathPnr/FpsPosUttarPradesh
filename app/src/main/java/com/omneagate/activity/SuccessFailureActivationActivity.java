...
public class SuccessFailureActivationActivity extends BaseActivity {
    ...
    private void continuePage(String message) {
        ...
        findViewById(R.id.buttonContinue).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.omneagate.activity.SuccessFailureActivationActivity.this, CardActivationActivity.class));
                Util.LoggingQueue(com.omneagate.activity.SuccessFailureActivationActivity.this, "Card Activation end", "Continue button pressed");
                finish();
            }
        });
    }
