...
import com.omneagate.Adapter.CurrentClosingAdapter;
...
public class TgCurrentClosingBalanceReport extends BaseActivity implements View.OnClickListener{
    ...
    List<Product> fpsCurrentClosingBalList;
    private Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tg_current_closing_balance_report);
        message = getIntent().getStringExtra("mode");
        Usb_Printer.getinstance(TgCurrentClosingBalanceReport.this).check_usb_permission();
        initView();
        new GetClosingBalanceActivty().execute();
    ...
    private void initView() {
        ...
        imageViewBack.setOnClickListener(TgCurrentClosingBalanceReport.this);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(TgCurrentClosingBalanceReport.this));
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imageViewBack:
                Intent backIntent = new Intent(TgCurrentClosingBalanceReport.this,TgReportsDashBoardActivity.class);
            ...
            case R.id.btnPrintAllotment:
                if(!isDataFound){
                    Toast.makeText(TgCurrentClosingBalanceReport.this,getString(R.string.data_not_found), Toast.LENGTH_SHORT).show();
                    return;
                }
                if (!connecting) {
                    Usb_Printer.getinstance(TgCurrentClosingBalanceReport.this).connectPrinter_new();
                } else {
                    Toast.makeText(TgCurrentClosingBalanceReport.this, R.string.usb_printer_connecting, Toast.LENGTH_SHORT).show();
                }
                break;

            case R.id.btnBack:
                Intent backIntent1 = new Intent(TgCurrentClosingBalanceReport.this,TgReportsDashBoardActivity.class);
    ...
    class GetClosingBalanceActivty extends AsyncTask<String, String, FPSCurrentClosingBalance> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            rationCardDetailDialog = new RationCardDetailDialog(TgCurrentClosingBalanceReport.this, getString(R.string.Downloading));
        ...
        protected FPSCurrentClosingBalance doInBackground(String... arg0) {
            try {
                return getCurrentClosingBalance();
            } catch (Exception e) {
                e.printStackTrace();
        ...
        @Override
        protected void onPostExecute(FPSCurrentClosingBalance fpsCurrentClosingBalance) {
            super.onPostExecute(fpsCurrentClosingBalance);
            rationCardDetailDialog.cancel();
            setValues(fpsCurrentClosingBalance);
        }
    }


    private void setValues(FPSCurrentClosingBalance fpsCurrentClosingBalance) {


        fpsCurrentClosingBalList = fpsCurrentClosingBalance.getProductList();

        for (Product product : fpsCurrentClosingBalList) {
            if ((product.getClosingBalance() != null) && (product.getClosingBalance() > 0.0)) {
                tempProductList.add(product);
            }

        }
        CurrentClosingAdapter salesDayAdapter = new CurrentClosingAdapter(TgCurrentClosingBalanceReport.this, tempProductList);
    ...
    private String teluguPrintData() {
        ...
        for (Product product : tempProductList) {
            ...
            String quantity ="" + product.getClosingBalance();
    ...
    private String new_englishPrintData() {
        ...
        textData.append("<font size=\"5\"> FPS CURRENT CLOSING BALANCE</font>" + "\n");
    ...
    private FPSCurrentClosingBalance getCurrentClosingBalance() {
        ...
        try {
          ...
          //  inputMap.put("currYear", year);
            ...
            fpsCurrentClosingBalance = XMLUtil.getFPSCurrentClosingBalance(inputMap);
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    TgGenericErrorDialog tgGenericErrorDialog =new TgGenericErrorDialog(TgCurrentClosingBalanceReport.this,""+e.getMessage());
    ...
    private class LogOutTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            Intent i = new Intent(TgCurrentClosingBalanceReport.this, TgLoginActivity.class);
