...
public class TgIrisScanActivity extends BaseActivity implements View.OnClickListener {
    ...
    String pidXml;
    private final String TAG = TgIrisScanActivity.class.getCanonicalName();
            ...
            case R.id.bt_submit:
                if (isCaptured) {
                   // new SendDealerDetails().execute();
                    ...
                    Toast.makeText(TgIrisScanActivity.this, getString(R.string.please_capture_iris), Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.btnScanWithFp:
                Intent i = new Intent(TgIrisScanActivity.this, TgScanFingerPrintActivity.class);
    ...
    void displayNoInternetDailog(){
        TgGenericErrorDialog tgGenericErrorDialog = new TgGenericErrorDialog(TgIrisScanActivity.this, getString(R.string.noNetworkConnection));
    ...
    private class SendDealerDetails extends AsyncTask<String, DealerAuthResponse, DealerAuthResponse> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            rationCardDetailDialog = new RationCardDetailDialog(TgIrisScanActivity.this, getString(R.string.authenticatingFingerPrint));
        ...
        protected void onPostExecute(DealerAuthResponse dealerAuthResponse) {
            ...
            //Log.e("ScanFingerPrintActivit", "dealerAuthResponse :" + dealerAuthResponse.toString());
            /*try {
                if (dealerAuthResponse.getRespMsgCode() != null) {
                    if (dealerAuthResponse.getRespMsgCode().equalsIgnoreCase("0")) {
                        ...
                        FPSDBHelper.getInstance(TgIrisScanActivity.this).InsetClosingBalance(dealerAuthResponse.getItemsCBList());

                        Intent loginIntent = new Intent(TgIrisScanActivity.this, TgDashBoardActivity.class);
                        loginIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(loginIntent);
                        finish();

                        *//*AuthenticationSuccessDialog authenticationSuccessDialog = new AuthenticationSuccessDialog(TgIrisScanActivity.this, getString(R.string.authentication_success),"TgIrisScanActivity");
                        authenticationSuccessDialog.setCanceledOnTouchOutside(false);
                        authenticationSuccessDialog.show();*//*

                    } else {
                        AuthenticationFailedDialog authenticationFailedDialog = new AuthenticationFailedDialog(TgIrisScanActivity.this, getString(R.string.authentication_failed));
        ...
        try {
           ...
           // inputMap.put("currMonth", "" + month);
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    TgGenericErrorDialog tgGenericErrorDialog =new TgGenericErrorDialog(TgIrisScanActivity.this,""+e.getMessage());
                    tgGenericErrorDialog.setCanceledOnTouchOutside(false);
                    tgGenericErrorDialog.show();
                }
            });
    ...
    private void initView() {
        try {
            ...
            ((LinearLayout)findViewById(R.id.fpsid_s)).setVisibility(View.GONE);
            ...
            networkConnection = new NetworkConnection(TgIrisScanActivity.this);

            scan_iris= MediaPlayer.create(this, R.raw.scan_iris);
            beep = MediaPlayer.create(this, R.raw.censorbeep);

            ((TextView) findViewById(R.id.top_textView)).setText(getString(R.string.fps_member) + " > " + getString(R.string.scan_iris));
            ...
            if(Util.needUidmMsking && memberUid.length()==12){
                txt_uid.setText(""+ Util.maskAadhaarNumber(memberUid,"XXXXXXXX####"));
            }else{
                txt_uid.setText(""+memberUid);
            }
    ...
    public void onBackPressed() {
        Intent backIntent = new Intent(TgIrisScanActivity.this, TgFpsMembersActivity.class);
...
*/
    ...
    private class LogOutTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            Intent i = new Intent(TgIrisScanActivity.this, TgLoginActivity.class);
