...
public class TgPortabilityDayWiseReport extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tg_portability_day_wise_report);
        message = getIntent().getStringExtra("mode");
        Usb_Printer.getinstance(TgPortabilityDayWiseReport.this).check_usb_permission();
        initView();
        recyclerView = (RecyclerView) findViewById(R.id.fps_sales_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(TgPortabilityDayWiseReport.this));
    ...
    private void initView() {
        ...
        imageViewBack.setOnClickListener(TgPortabilityDayWiseReport.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imageViewBack:
                Intent backIntent = new Intent(TgPortabilityDayWiseReport.this,TgReportsDashBoardActivity.class);
            ...
            case R.id.btnPrintAllotment:
                if(!isDataFound){
                    Toast.makeText(TgPortabilityDayWiseReport.this,getString(R.string.data_not_found), Toast.LENGTH_SHORT).show();
                    return;
                }

                if (!connecting) {
                    Usb_Printer.getinstance(TgPortabilityDayWiseReport.this).connectPrinter_new();
                } else {
                    Toast.makeText(TgPortabilityDayWiseReport.this, R.string.usb_printer_connecting, Toast.LENGTH_SHORT).show();
                }
                break;

            case R.id.btnBack:
                Intent backIntent1 = new Intent(TgPortabilityDayWiseReport.this,TgReportsDashBoardActivity.class);
    ...
    class GetPortablityMonthWiseReport extends AsyncTask<String, String, FPSPortablityDayWiseReport> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            rationCardDetailDialog = new RationCardDetailDialog(TgPortabilityDayWiseReport.this, getString(R.string.Downloading));
            rationCardDetailDialog.setCanceledOnTouchOutside(false);
            rationCardDetailDialog.show();
        }

        protected FPSPortablityDayWiseReport doInBackground(String... arg0) {
            try {
                return getDailySaleReport();
            } catch (Exception e) {
                e.printStackTrace();
                return new FPSPortablityDayWiseReport();
            }
        }

        @Override
        protected void onPostExecute(FPSPortablityDayWiseReport fpsIssueDaywiseReportResponseDto) {
    ...
    private void setValues(FPSPortablityDayWiseReport fpsIssueDaywiseReportResponseDto) {
        ...
        SalesDayAdapter salesDayAdapter = new SalesDayAdapter(TgPortabilityDayWiseReport.this, tempProductList);
    ...
    private String new_englishPrintData() {
        ...
        textData.append("<font size=\"5\">   PORTABILITY DAY REPORT</font>" + "\n");
    ...
    private String teluguPrintData() {
        ...
        textData.append("<font size=\"5\">     పోర్టబిలిటీ రోజుల నివేదిక</font>" + "\n");
        textData.append("</pre>");
    ...
    private FPSPortablityDayWiseReport getDailySaleReport() {
        FPSPortablityDayWiseReport fpsIssueDaywiseReport = new FPSPortablityDayWiseReport();
        try {
            ...
            fpsIssueDaywiseReport = XMLUtil.getFPSPortablilityDayWiseReport(inputMap);
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    TgGenericErrorDialog tgGenericErrorDialog =new TgGenericErrorDialog(TgPortabilityDayWiseReport.this,""+e.getMessage());
    ...
    private class LogOutTimerTask extends TimerTask {
        ...
        @Override
        public void run() {
            Intent i = new Intent(TgPortabilityDayWiseReport.this, TgLoginActivity.class);
