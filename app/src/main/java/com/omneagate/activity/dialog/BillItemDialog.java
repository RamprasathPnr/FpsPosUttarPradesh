...
public class BillItemDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String qty1 = Util.quantityRoundOffFormat(entitle.getEntitledQuantity());
        entitledQuantity.setText(qty1);
        String qty2 = Util.quantityRoundOffFormat(entitle.getHistory());
        purchasedAmount.setText(qty2);
        String qty3 = Util.quantityRoundOffFormat(entitle.getCurrentQuantity());
        remainingAmount.setText(qty3);
