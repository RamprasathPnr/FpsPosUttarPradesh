...
public class BiometricAlertDialog extends Dialog implements View.OnClickListener {
    Context dialogContext;
    Button okButton;
    String message = "";
//    ArrayList<String> productsOutOfStock;

    public BiometricAlertDialog(Context context, String msg) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_biometric_alert);
