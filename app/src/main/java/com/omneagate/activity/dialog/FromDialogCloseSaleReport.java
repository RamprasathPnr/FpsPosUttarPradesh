...
import com.omneagate.activity.CloseSaleSummaryActivity;
 ...
 */
public class FromDialogCloseSaleReport extends Dialog implements View.OnClickListener {
    ...
    public FromDialogCloseSaleReport(Activity _context) {
        super(_context);
        context = _context;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonNwOk:
                ...
                ((MonthlyCloseSaleReportActivity) context).setFromTextDate(sdf.format(widget.getSelectedDate().getDate()));
                dismiss();
                break;
