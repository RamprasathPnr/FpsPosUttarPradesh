 ...
 */
public class InspectionLogoutDialog extends Dialog implements
    ...
    public InspectionLogoutDialog(Activity _context) {
        super(_context);
        context = _context;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonNwOk:
                dismiss();
                ((BaseActivity) context).inspectionLogOutSuccess();
                break;
