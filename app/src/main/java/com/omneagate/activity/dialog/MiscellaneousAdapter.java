...
public class MiscellaneousAdapter extends BaseAdapter {
    Context mActivity;
    List<GridMenuDto> GridMenuDto;
    private LayoutInflater mInflater;

    public MiscellaneousAdapter(Context beneficiaryMenuActivity, List<GridMenuDto> gridData) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            view = mInflater.inflate(R.layout.adapter_miscellaneous, null);
