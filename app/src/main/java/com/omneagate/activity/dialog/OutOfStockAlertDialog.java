...
public class OutOfStockAlertDialog extends Dialog implements View.OnClickListener {
    Context dialogContext;
    Button okButton;
    ArrayList<String> productsOutOfStock;

    public OutOfStockAlertDialog(Context context, ArrayList<String> products) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Util.setTamilText((TextView) findViewById(R.id.alertMsgText), R.string.out_of_stock_alert_msg );
