...
public class PaymentModeDialogWithOTP extends Dialog implements View.OnClickListener{
    //Activity context
    private final Activity context;  //    Context from the user

    /*Constructor class for this dialog*/
    public PaymentModeDialogWithOTP(Activity _context) {
        super(_context);
        context = _context;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonCash:
                ((SalesSummaryActivity)context).submitBill();
                dismiss();
                break;

            case R.id.buttonCard:
                ((SalesSummaryActivity)context).submitCardPayment();
                dismiss();
                break;
