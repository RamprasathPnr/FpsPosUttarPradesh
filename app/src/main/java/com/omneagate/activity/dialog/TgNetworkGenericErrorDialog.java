 ...
 */
public class TgNetworkGenericErrorDialog extends Dialog implements View.OnClickListener {
    ...
    public TgNetworkGenericErrorDialog(Activity context, String dialogText) {
        super(context);
        this.context = context;
        this.strDialogText = dialogText;
    }
    public TgNetworkGenericErrorDialog(Activity context,String dialogText,boolean logoutStatus){
        super(context);
        this.context = context;
        this.strDialogText = dialogText;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonOk:
                if(logoutStatus){
                    dismiss();
                    ((TgLoginActivity)context).checkUserApk();
