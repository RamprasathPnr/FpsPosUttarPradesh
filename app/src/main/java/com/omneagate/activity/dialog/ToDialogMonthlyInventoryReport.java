 ...
 */
public class ToDialogMonthlyInventoryReport extends Dialog implements View.OnClickListener {
    ...
    public ToDialogMonthlyInventoryReport(Activity _context) {
        super(_context);
        context = _context;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String minDate = FPSDBHelper.getInstance(context).getMinimumBillDate();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonNwOk:
                ...
                ((MonthlyInventoryReportActivity) context).setToTextDate(sdf.format(widget.getSelectedDate().getDate()));
                dismiss();
                break;
