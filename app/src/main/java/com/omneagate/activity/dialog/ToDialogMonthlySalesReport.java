 ...
 */
public class ToDialogMonthlySalesReport extends Dialog implements View.OnClickListener {
    ...
    public ToDialogMonthlySalesReport(Activity _context) {
        super(_context);
        context = _context;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonNwOk:
                ...
                ((MonthlySalesReportActivity) context).setToTextDate(sdf.format(widget.getSelectedDate().getDate()));
                dismiss();
                break;
