 ...
 */
public class UnsavedStockInspectionDialog extends Dialog implements
        View.OnClickListener {
    private final Activity context;  //    Context from the user
    private  String alerttext;

    /*Constructor class for this dialog*/
    public UnsavedStockInspectionDialog(Activity _context,String alerttext) {
        super(_context);
        context = _context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tvloginBack)).setText(alerttext);
